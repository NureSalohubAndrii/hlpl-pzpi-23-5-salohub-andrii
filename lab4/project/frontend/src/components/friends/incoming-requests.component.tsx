...
import { DeleteFriendType, type IncomingFriendRequest } from '../../types/friends.types';
import { useAcceptFriendRequestMutation } from '../../queries/friends.queries';

interface IncomingRequestsProps {
  requests: IncomingFriendRequest[];
}

export const IncomingRequests: FC<IncomingRequestsProps> = ({ requests }) => {
